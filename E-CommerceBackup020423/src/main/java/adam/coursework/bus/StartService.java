...
//        af.create(a);
    ...
    public void setOrder(Orders o, List<Basket> items, List<String> titles, List<Integer> integerCopies) {
        ...
        o.setPayment(retrievePayment().get(0));
